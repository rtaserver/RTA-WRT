...
rebuild_firmware() {
   ...
   # php8-mod-xml php8-mod-xmlreader php8-mod-xmlwriter php8-mod-zip libopenssl-legacy"
    ...
    misc+=" tailscale1 luci-app-tailscale luci-app-cpufreq luci-app-mmconfig luci-app-temp-status luci-app-rakitanmanager luci-theme-alpha luci-theme-argon luci-app-droidnet"
