...
custom_packages() {
    ...
    CURVER=$(echo $op_branch | awk -F. '{print $1"."$2}')
    other_packages=(
        "tailscale|https://downloads.$op_sourse.org/releases/23.05.5/packages/$ARCH_3/packages"
...
rebuild_firmware() {
   ...
   # php8-mod-xml php8-mod-xmlreader php8-mod-xmlwriter php8-mod-zip libopenssl-legacy"
    ...
    misc+=" luci-app-tailscale luci-app-cpufreq luci-app-mmconfig luci-app-temp-status luci-app-rakitanmanager luci-theme-alpha luci-theme-argon luci-app-droidnet"
