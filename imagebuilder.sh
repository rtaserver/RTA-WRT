...
custom_packages() {
    ...
    declare -a other_packages=(
        ...
        "dns2tcp|https://mirrors.pku.edu.cn/immortalwrt/releases/packages-$CURVER/$ARCH_3/packages"
        ...
        "luci-app-zerotier|https://mirrors.pku.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
        "luci-app-ramfree|https://mirrors.pku.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
        "luci-app-3ginfo-lite|https://mirrors.pku.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
        "modemband|https://mirrors.pku.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/packages"
        "luci-app-modemband|https://mirrors.pku.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
        "luci-app-sms-tool-js|https://mirrors.pku.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
