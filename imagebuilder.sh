...
custom_packages() {
    ...
    declare -a other_packages=(
        ...
        "dns2tcp|https://mirrors.shanghaitech.edu.cn/immortalwrt/releases/packages-$CURVER/$ARCH_3/packages"
        ...
        "luci-app-zerotier|https://mirrors.shanghaitech.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
        "luci-app-ramfree|https://mirrors.shanghaitech.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
        "luci-app-3ginfo-lite|https://mirrors.shanghaitech.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
        "modemband|https://mirrors.shanghaitech.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/packages"
        "luci-app-modemband|https://mirrors.shanghaitech.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
        "luci-app-sms-tool-js|https://mirrors.shanghaitech.edu.cn/immortalwrt/releases/packages-24.10/$ARCH_3/luci"
