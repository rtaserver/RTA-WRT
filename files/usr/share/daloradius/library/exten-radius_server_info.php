...
function check_service($sname) {
	if ($sname != '') {
		...
		if ($ret_service == 0) {
			...
			return "<font color='red'><b>Not Running</b></font>";
		}
	} else {
		return "𝘯𝘰 𝘴𝘦𝘳𝘷𝘪𝘤𝘦 𝘯𝘢𝘮𝘦";
	}
}
...
<?php
	echo "<h3><center>𝗦𝗲𝗿𝘃𝗶𝗰𝗲 𝗦𝘁𝗮𝘁𝘂𝘀</h3>";
?>

<table class='summarySection'>
  <tr>
    <td class='summaryKey'> RadiusD </td>
  ...
  <tr>
    <td class='summaryKey'> Chilli </td>
    <td class='summaryValue'><span class='sleft'><?php echo check_service("chilli"); ?></span> </td>
  </tr>
  <tr>
    <td class='summaryKey'> Openclash </td>
    <td class='summaryValue'><span class='sleft'><?php echo check_service("openclash");  ?></span> </td>
  </tr>
</table>
