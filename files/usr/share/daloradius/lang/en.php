...
$l['all']['copyright1'] = "daloRADIUS Web Management Server";
...
$l['all']['QrcodeLength'] = "Length of qrcode string";
...
$l['all']['CreateQrcodeUsers'] = "Create QrCode Users";
...
$l['Tooltip']['qrcodeToCreateTooltip'] = "Example: 4<br/>&nbsp;&nbsp;&nbsp;
					The amount of random users to create<br/>&nbsp;&nbsp;&nbsp;
					qrCode";		
...
$l['button']['SearchUsers'] = " 𝘚𝘦𝘢𝘳𝘤𝘩 𝘜𝘴𝘦𝘳𝘴";
