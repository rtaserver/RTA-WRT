...
?>
        ...
        <input type='button' onclick="self.location='graphs-overall_download.php?type=monthly&size&username=<?php
                echo $username ?>'" value='Graphs - Downloads' class='button'/>

        <input type='button' onclick="self.location='graphs-overall_upload.php?type=monthly&size&username=<?php
